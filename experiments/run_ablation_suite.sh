...
run_eval \
  ...
  "./checkpoints/UR_PepCCD_MoE/rl_finetuned_diffusion.pt" \
  "./checkpoints/UR_PepCCD_MoE/rl_uncertainty_head.pt" \
  "./evaluation/pepflow_eval_reward_guided_legacy"

run_eval \
  "elbo_full" \
  "./checkpoints/UR_PepCCD_MoE/rl_elbo_diffusion.pt" \
  "./checkpoints/UR_PepCCD_MoE/rl_elbo_uncertainty_head.pt" \
  "./evaluation/pepflow_eval_elbo_full"
...
echo "[$(date '+%F %T')] ablation suite completed"
